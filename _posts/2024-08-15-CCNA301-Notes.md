...
- Dudble click the router and click on the config tab. then chnage the displayname in this example I've named to R1-LIV.

![alt text](../assets/img/Posts/RouterConfig/R1-LIVv2.png)
